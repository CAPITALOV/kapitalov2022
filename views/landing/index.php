...
<div class="container">
    ...
    <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <p>Прогноз будущего движения рынка показывается графически с указанием точных дат изменения курса.</p>
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p>Мы работаем с 2001 г. и по статистике сбываемость прогнозов не менее 60%.</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-4">
            <img src="/images/index/snapshot.png" width="100%" style="margin-top: 50px;" class="thumbnail">
        </div>
    ...
    <footer>
        <div class="row">
            <div class="col-lg-12">
                <p>© 2007 — 2015 | www.capitalov.com | Эксклюзивные финансовые услуги | Национальное Агентство Капиталов | +7 (499) 394-27-43</p>
            </div>
        </div>
    </footer>

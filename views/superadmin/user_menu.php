...
$this->registerJsFile('/js/pages/superadmin/user_menu.js', ['depends' => ['yii\grid\GridViewAsset']]);
...
<div class="site-about">
    ...
    <a href="/userMenu/add" class="btn btn-primary" style="margin: 20px 0px 20px 0px; ">Добавить</a>
